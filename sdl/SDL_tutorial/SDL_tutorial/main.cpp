...
/*
 ...
 We're also going to include C standard IO to print errors to the console.
 
 You're probably more used to using iostream, but I use printf in my applications because it's more thread safe.
 
 For these early applications, use what ever you are most comfortable with.
...
int main(int argc, const char * argv[]) {
    ...
    */
    ...
    /*
     ...
     After the window has delayed there for 8 seconds, we'll destroy the window to free its memory.
